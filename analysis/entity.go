...
func (b *builder) acceptEntitySample(ev s2replay.Event) {
	...
	sample := EntitySample{
		...
		CameraAngles:             ev.EntitySample.CameraAngles,
		CameraAnglesTicks:        ev.EntitySample.CameraAnglesTicks,
		CameraAnglesSourceFields: ev.EntitySample.CameraAnglesSourceFields,
		HasCameraAngles:          ev.EntitySample.HasCameraAngles,
